...
class Index extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (type === ActionTypes.BASEDATA_EMPLOYEE_LIST_GOT) {
      this.setState({loading: false, data})
    } else if (type === ActionTypes.BASEDATA_EMPLOYEE_LIST_FAILURE) {
      this.setState({loading: false})
    } else if (type === ActionTypes.BASEDATA_EMPLOYEE_DELETE_BEGIN || type === ActionTypes.BASEDATA_EMPLOYEE_LIST_QUERY) {
      this.setState({loading: true})
    } else if (type === ActionTypes.BASEDATA_EMPLOYEE_DELETE_SUCCESS) {
      this.props.getEmployeeList(this.state.tableCondition)
  ...
  onChange = (pagination, filters, sorter) => {
    ...
    this.props.getEmployeeList({pagination, filters})
    this.setState({
  ...
  onSearch = () => {
    ...
    this.props.getEmployeeList(tableCondition)
  }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <span>
            <Link to={{
              pathname: '/basedata/employee/updateemployee',
              state: {id: record.key}
            }}>修改</Link>
    ...
    return <Fragment>
      <div className="actions"><Link className="button"
                                     to="/basedata/employee/addemployee"><span>新增业务员</span></Link></div>
      <hr/>
      <div className="lists">
