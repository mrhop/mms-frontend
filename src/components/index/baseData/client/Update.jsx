...
class Update extends Component {
  ...
  componentWillMount() {
    ...
    if (location.state && location.state.id) {
      ...
      this.props.getClientSingle({id: location.state.id})
    } else {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (type === ActionTypes.BASEDATA_CLIENT_SINGLE_GOT) {
      this.setState({loading: false, data})
    } else if (type === ActionTypes.BASEDATA_CLIENT_SAVE_SUCCESS) {
      history.push('/basedata/client')
    } else if (type === ActionTypes.BASEDATA_CLIENT_SAVE_FAILURE) {
  ...
  render() {
    ...
    let alertMsg = null
    if (type === ActionTypes.BASEDATA_CLIENT_SINGLE_FAILURE) {
      alertMsg = <Alert
        message="获取失败"
...
Update.propTypes = {
  ...
  getClientSingle: PropTypes.func,
  form: PropTypes.object.isRequired,
}


const mapStateToProps = (state) => {
  return {...state.baseDataClientSingle}
}
